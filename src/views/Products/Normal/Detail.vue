<template>
  <div>
    <section>
      <menu-component classMenu="ProductsNormalDetail"></menu-component>
            ...
            <div class="card-body py-3 p-0">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <b>{{this.datasProductNormalCompany.name+' ( '+this.datasProductNormalDetail.company_id+' )'}}</b>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <b>{{this.datasProductNormalDetail.product_code}}</b>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <b>{{this.datasProductNormalDetail.product_description}}</b>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <b>{{this.datasProductNormalDetail.uom_code + ' ( ' +this.datasProductNormalUom.uom_description+' )'}}</b>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <b>{{this.datasProductNormalDetail.currency}}</b>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                   <h3 class="block__title mb-lg-4">{{$t('inventory')}}</h3>
                    ...
                    <div v-for="stock in this.datasProductNormalDetail.inventory" :key="stock.inventory_id">
...
export default {
  name: 'ProductsNormalDetail',
    ...
    data () {
        ...
        datasProductNormalCompany:[],
        datasProductNormalUom:[],
        maxToasts: 100,
        isLoading: false,  
        position: 'up right',
        closeBtn: true,  
    ...
    methods: {
        ...
        fetchIt() {
            ...
            return this.$http.get(baseURI).then((response) => {
                ...
                this.datasProductNormalCompany  = response.data.datas.company
                this.datasProductNormalUom      = response.data.datas.uom_description
            })
