<template>
  <div>
    <section>
      <menu-component classMenu="ProductsNormalEdit"></menu-component>
            ...
            <div class="card-body py-3 p-0">
                ...
                <div class="col-lg-6">
                    <h3 class="block__title mb-lg-4">{{$t('product')}}</h3>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <v-select :options="optionsUom" label="uom_description" placeholder="Choose a Uom" v-model="forms.uom_code" @search="searchUom" autocomplete>
                            <template #search="{attributes, events}">
                                <input
                                class="vs__search"
                ...
                <div class="col-lg-6">
                   <h3 class="block__title mb-lg-4">{{$t('inventory')}}</h3>
                    ...
                    <div v-for="stock in this.datasProductNormalEdit.inventory" :key="stock.inventory_id">
    ...
    data () {
        return {
            ...
            forms: {product_id:'',company:'', product_code:'', product_name: '', uom_code: '', price: '', width: ''
                    ...
                    , currency: '', barcode: '', time_to_live: '', type: ''
            },
            options: [],
            optionsUom: [],
            money: {
                ...
                if (result.value) {
                    ...
                    if (this.forms.product_code.trim()) {
                        ...
                        var formData = {
                            ...
                            uom_code            : this.forms.uom_code.uom_code,
                        ...
                        const baseURI  =  this.$settings.endPoint+"/products/normal/update/"+this.forms.product_id;
