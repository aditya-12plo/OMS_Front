  ...
  data () {
    ...
    methods: {
      ...
      downloadData(){
        ...
        const baseURI  =  this.$settings.endPoint+"/user/download";
        this.$http.post(baseURI,formData,{responseType: 'blob'})
          .then((response) => {
            ...
            fileLink.setAttribute('download', 'users-datas.xls');
