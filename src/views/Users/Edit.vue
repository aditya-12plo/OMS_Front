                ...
                <div class="col-lg-12">
                    <h3 class="block__title mb-lg-4">Form</h3>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" v-model="forms.mobile" class="form-control input-style" id="mobile" placeholder="Mobile" maxlength="12" @keydown.space="(event) => event.preventDefault()" @keypress="isNumber($event)">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" v-model="forms.fax" class="form-control input-style" id="fax" placeholder="Fax" maxlength="12" @keydown.space="(event) => event.preventDefault()" @keypress="isNumber($event)">
